...
public class NewSet {
    ...
    private static final String spaceAnd_default = " /／＼|｜ﾉ＞＜∧";
    private static final String _dontMoveX = "-ｰ一ﾆ二ニ＝ヽﾍ丶ゝ=ノへ";
    private static final String _dontSpin = "<>十七小心厶うフメラ弋イレツシソ";
    private static final String _dontMove = "_\"\\×.';ΤLＯ^７∠`∈Ｏrj≠≧ｪxｭt≫┴┘└┐┤├()[]" +
            "ィﾊハいァアｿﾝﾑゝムんこチスゞヾくﾏ廴キ人八厂しミ斗孑公少芹乂云示三从彡込弐";
    private static final String[] _filling = {"ﾐ", " Eternal Night ★", "──── ⋆⋅☆⋅⋆ ──", " +", ":"};
    ...
    private static Font chooseSize(Font font, int pixDst) throws FontFormatException {
        ...
        while (pixSize != pixDst) {
            ...
            counter++;
            if (counter == 15) throw new FontFormatException(font.getFontName() + " can't get a font of this size");
        }
        return font;
    }
